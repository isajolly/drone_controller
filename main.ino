...
#define COEF_KP -8//-7.9184 //-0.15     //les coefficients sont proportionnels à I donc à modifier proportionnellement
#define COEF_KD -0.02//-1.94   //-0.04     //ou à modifier en changeant w0 et w0^2
